...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex py-6 justify-between items-center navbar'>
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1  cursor-pointer">
        {navLinks.map((nav, index) => (
          ...
          <div className='sm:hidden flex flex-1 justify-end items-center'>
              <img 
              src={toggle ? close : menu} //點擊時toggle useState預設為false,所以是menu true時為close
              alt="menu"
